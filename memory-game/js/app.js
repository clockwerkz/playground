const icons = ['fa-adobe', 'fa-mandalorian', 'fa-aws','fa-bitcoin', 'fa-git', 'fa-jenkins', 'fa-laravel', 'fa-reddit-alien','fa-adobe', 'fa-mandalorian', 'fa-aws','fa-bitcoin', 'fa-git', 'fa-jenkins', 'fa-laravel', 'fa-reddit-alien'];
